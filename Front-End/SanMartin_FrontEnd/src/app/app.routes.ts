...
import { DatabaseUnavailableComponent } from './pages/database-unavailable/database-unavailable.component.js';
import { SignInComponent } from './pages/sign-in/sign-in.component.js';
...
export const routes: Routes = [
    ...
    {path:'db-unavailable', component:DatabaseUnavailableComponent}
];

export const routingComponents = [PuntosventaListaComponent, IndexComponent, SmContactComponent, LogInComponent, SignInComponent, CartComponent, EditUserComponent, AddAddressComponent,
